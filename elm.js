...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Msg.Msg":{"args":[],"tags":{"ResetCliplet":["String"],"UrlChange":["Page.Page"],"Noop":[],"BookReceived":["Result.Result String Reading.Book"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.Page":{"args":[],"tags":{"AboutPage":[],"ResumePage":[],"ProjectIndexPage":[],"ProjectPage":["String"]}}},"aliases":{"Reading.Book":{"args":[],"type":"{ title : String , bookUrl : String , author : String , imageUrl : String }"}},"message":"Msg.Msg"},"versions":{"elm":"0.18.0"}});
}
