...
var _user$project$StyleHelpers$mapVariation = F2(
	function (fn, attr) {
		var _p0 = attr;
		switch (_p0.ctor) {
			case 'Event':
...
var _user$project$StyleHelpers$styleMap = F3(
				...
				return _mdgriffith$style_elements$Element_Internal_Model$Element(
					_elm_lang$core$Native_Utils.update(
						_p1._0,
						{
							...
							child: A3(_user$project$StyleHelpers$styleMap, toParent, toParentVariation, _p1._0.child),
							absolutelyPositioned: A2(
								_elm_lang$core$Maybe$map,
								_elm_lang$core$List$map(
									A2(_user$project$StyleHelpers$styleMap, toParent, toParentVariation)),
								_p1._0.absolutelyPositioned),
							attrs: A2(
								_elm_lang$core$List$map,
								_user$project$StyleHelpers$mapVariation(toParentVariation),
								_p1._0.attrs)
						}));
			case 'Layout':
				return _mdgriffith$style_elements$Element_Internal_Model$Layout(
...
var _user$project$Header$spacer = A3(
	...
	_mdgriffith$style_elements$Element$empty);
var _user$project$Header$logo = A4(
	_mdgriffith$style_elements$Element$image,
	'/assets/logo.jpg',
	_user$project$Header$None,
	{
			...
			_user$project$Header$Header,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$height(
							_mdgriffith$style_elements$Element_Attributes$px(_user$project$Header$headerHeight)),
						_1: {
							ctor: '::',
...
var _user$project$Project$Project = F6(
	function (a, b, c, d, e, f) {
		return {title: a, description: b, imageLocation: c, clipletLocation: d, url: e, page: f};
	});
...
var _user$project$Projects_Prototypes$prototypes = {
	title: 'Prototypes',
	description: 'bogus game',
	imageLocation: 'prototypes.jpg',
	clipletLocation: '',
	url: 'prototypes',
	page: _mdgriffith$style_elements$Element$text('prototypes')
};

var _user$project$Projects_Playbook$playbook = {
	title: 'Playbook',
	description: 'bogus game',
...
var _user$project$Projects_Quillbox$quillbox = {
	title: 'Quillbox',
	description: 'type your latex quickly',
	imageLocation: 'quill.jpg',
	clipletLocation: '',
	url: 'quillbox',
	page: _mdgriffith$style_elements$Element$text('quillbox')
};

var _user$project$Projects_Symmetry$symmetry = {
	title: 'Symmetry',
	description: 'bogus game',
	imageLocation: 'symmetry.jpg',
	clipletLocation: '',
	url: 'symmetry',
	page: _mdgriffith$style_elements$Element$text('symmetry')
};
	...
	_1: {
		...
		_0: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Projects_Quillbox$quillbox,
					_1: {
						ctor: '::',
...
var _user$project$ProjectIndex$chipImage = function (project) {
	var clipletPath = A2(_elm_lang$core$Basics_ops['++'], '/assets/', project.clipletLocation);
	var staticImagePath = A2(_elm_lang$core$Basics_ops['++'], '/assets/', project.imageLocation);
	return A2(
		_mdgriffith$style_elements$Element$within,
		{
			ctor: '::',
...
var _user$project$ProjectIndex$styles = {
	ctor: '::',
	_0: A2(
		_mdgriffith$style_elements$Style$style,
							...
							_1: {
								...
								_0: A2(
									...
									_user$project$ProjectIndex$CategoryName,
									{
										...
										_1: {
											ctor: '::',
											_0: _user$project$StyleHelpers$scaledFont(2),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
...
var _user$project$Page$toElement = function (page) {
	var _p0 = page;
	if (_p0.ctor === 'ProjectIndexPage') {
		return A3(_user$project$StyleHelpers$styleMap, _user$project$SharedStyles$ProjectIndexStyle, _elm_lang$core$Basics$identity, _user$project$ProjectIndex$element);
	} else {
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A3(
						...
						A3(
							...
							{
								ctor: '::',
								_0: A3(_user$project$StyleHelpers$styleMap, _user$project$SharedStyles$HeaderStyle, _elm_lang$core$Basics$identity, _user$project$Header$element),
								_1: {
									ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: function () {
						var _p0 = model.currentlyReading;
						if (_p0.ctor === 'Err') {
							return _elm_lang$html$Html$text(_p0._0);
						} else {
							return _user$project$Reading$element(_p0._0);
						}
					}(),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$BookReceived = function (a) {
...
var _user$project$Main$init = function (location) {
	return {
		...
		_1: _user$project$Reading$getCurrentlyReading(_user$project$Main$BookReceived)
	};
};
