...
var _user$project$Page$ProjectPage = function (a) {
...
var _user$project$Projects_Prototypes$prototypes = {title: 'Prototypes', id: 'prototypes', description: 'games that were not to be', imageLocation: 'exquisine-icon.png', clipletLocation: 'exquisine-cliplet.webm', url: '#/projects/prototypes'};
		...
		A3(
			...
			},
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: paragraph('I like to make science and math come to life. I do this by transforming written words and equations into something you can poke and prod. Everyone transforms the systems they learn about into these interactive toys; they\'re just usually trapped inside of people\'s heads. I want to bring them out into the light of day so that you can play along with me.'),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Page$ProjectPage,
							A2(
