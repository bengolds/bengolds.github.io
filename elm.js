...
var _user$project$Projects_Playbook$playbook = {title: 'Playbook', id: 'playbook', description: 'raising math from the dead', imageLocation: 'playbook.png', clipletLocation: 'playbook.webm', url: 'playbook'};

var _user$project$Projects_Prototypes$prototypes = {title: 'Prototypes', id: 'prototypes', description: 'bogus game', imageLocation: 'prototypes.jpg', clipletLocation: '', url: 'prototypes'};
...
var _user$project$Projects_RainbowRacer$rainbowRacer = {title: 'Rainbow Racer', id: 'rainbow-racer', description: 'adrenalized arcade game', imageLocation: 'rainbowracer.png', clipletLocation: 'rainbowracer.webm', url: 'rainbow-racer'};
...
var _user$project$ProjectIndex$categories = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: 'Games',
...
var _user$project$ProjectIndex$CategoryName = {ctor: 'CategoryName'};
var _user$project$ProjectIndex$Category = {ctor: 'Category'};
var _user$project$ProjectIndex$Description = {ctor: 'Description'};
var _user$project$ProjectIndex$Title = {ctor: 'Title'};
var _user$project$ProjectIndex$Cliplet = {ctor: 'Cliplet'};
var _user$project$ProjectIndex$StaticImage = {ctor: 'StaticImage'};
var _user$project$ProjectIndex$ImageArea = {ctor: 'ImageArea'};
var _user$project$ProjectIndex$chipImage = function (project) {
	...
	return A2(
		_mdgriffith$style_elements$Element$within,
		{
			...
			_0: A4(
				...
				_user$project$ProjectIndex$StaticImage,
				{
					ctor: '::',
...
var _user$project$ProjectIndex$TextArea = {ctor: 'TextArea'};
var _user$project$ProjectIndex$Chip = {ctor: 'Chip'};
var _user$project$ProjectIndex$chip = function (project) {
	return A2(
		...
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$ProjectIndex$chipImage(project),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$column,
						...
						},
						{
							...
							_0: A3(
								_mdgriffith$style_elements$Element$el,
								_user$project$ProjectIndex$Title,
								{ctor: '[]'},
							...
							_1: {
								...
								_0: A3(
									_mdgriffith$style_elements$Element$el,
									_user$project$ProjectIndex$Description,
									{ctor: '[]'},
...
var _user$project$ProjectIndex$None = {ctor: 'None'};
var _user$project$ProjectIndex$styles = function () {
...
var _user$project$ProjectIndex$category = function (_p0) {
	var _p1 = _p0;
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$ProjectIndex$Category,
...
var _user$project$ProjectIndex$element = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$ProjectIndex$None,
	{
		ctor: '::',
...
var _user$project$Page$fakeLocation = function (path) {
	return {
		href: '',
		host: '',
		hostname: '',
		...
		pathname: '',
		search: '',
		hash: A2(_elm_lang$core$Basics_ops['++'], '#/', path),
		username: '',
		password: ''
	};
};
...
var _user$project$Page$fromLocation = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Page$pageParser, location);
};
	...
	return {
		...
		_0: {
			page: A2(
				_elm_lang$core$Maybe$withDefault,
				_user$project$Page$AboutPage,
				_user$project$Page$fromLocation(location)),
			currentlyReading: _elm_lang$core$Result$Err('no book')
		},
		_1: _user$project$Reading$getCurrentlyReading(_user$project$Msg$BookReceived)
	};
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'UrlChange':
				var _p2 = _user$project$Page$fromLocation(_p1._0);
				if (_p2.ctor === 'Nothing') {
			...
			default:
				return {
					...
					_1: _user$project$Main$sendInfoOut(
						_user$project$Main$ResetClipletOut(_p1._0))
				};
		}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Msg.Msg":{"args":[],"tags":{"ResetCliplet":["String"],"UrlChange":["Navigation.Location"],"BookReceived":["Result.Result String Reading.Book"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Reading.Book":{"args":[],"type":"{ title : String , bookUrl : String , author : String , imageUrl : String }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Msg.Msg"},"versions":{"elm":"0.18.0"}});
}
