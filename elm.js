			...
			return A2(_elm_lang$core$String$startsWith, '?', tagName) ? _elm_lang$core$Result$Ok(
				{
					...
					_1: firstClose + 1
				}) : (A2(_elm_lang$core$String$contains, '/>', trimmed) ? _elm_lang$core$Result$Ok(
				{
					ctor: '_Tuple2',
					_0: A3(
						_eeue56$elm_xml$Xml$Tag,
...
var _mdgriffith$style_elements$Style_Sheet$mix = _mdgriffith$style_elements$Style_Internal_Batchable$batch;
var _mdgriffith$style_elements$Style_Sheet$merge = function (_p0) {
	var _p1 = _p0;
	return _mdgriffith$style_elements$Style_Internal_Batchable$many(
		_mdgriffith$style_elements$Style_Internal_Batchable$toList(_p1._0));
};
var _mdgriffith$style_elements$Style_Sheet$ChildSheet = function (a) {
	return {ctor: 'ChildSheet', _0: a};
};
var _mdgriffith$style_elements$Style_Sheet$map = F3(
	function (toParent, toParentVariation, styles) {
		return _mdgriffith$style_elements$Style_Sheet$ChildSheet(
			A2(
				_elm_lang$core$List$map,
				_mdgriffith$style_elements$Style_Internal_Batchable$map(
					A2(_mdgriffith$style_elements$Style_Internal_Model$mapClassAndVar, toParent, toParentVariation)),
				styles));
	});
...
var _user$project$ElementHelpers$mapVariation = F2(
	function (fn, attr) {
		...
		switch (_p0.ctor) {
			case 'Event':
				return _mdgriffith$style_elements$Element_Internal_Model$Event(_p0._0);
			case 'InputEvent':
				return _mdgriffith$style_elements$Element_Internal_Model$InputEvent(_p0._0);
			case 'Attr':
				return _mdgriffith$style_elements$Element_Internal_Model$Attr(_p0._0);
			case 'Vary':
				return A2(
...
var _user$project$ElementHelpers$styleMap = F3(
	function (toParent, toParentVariation, el) {
		var _p1 = el;
		switch (_p1.ctor) {
			case 'Empty':
				return _mdgriffith$style_elements$Element_Internal_Model$Empty;
			case 'Spacer':
				return _mdgriffith$style_elements$Element_Internal_Model$Spacer(_p1._0);
			case 'Text':
				return A2(_mdgriffith$style_elements$Element_Internal_Model$Text, _p1._0, _p1._1);
			case 'Element':
				return _mdgriffith$style_elements$Element_Internal_Model$Element(
					_elm_lang$core$Native_Utils.update(
						_p1._0,
						{
							style: A2(_elm_lang$core$Maybe$map, toParent, _p1._0.style),
							child: A3(_user$project$ElementHelpers$styleMap, toParent, toParentVariation, _p1._0.child),
							absolutelyPositioned: A2(
								_elm_lang$core$Maybe$map,
								_elm_lang$core$List$map(
									A2(_user$project$ElementHelpers$styleMap, toParent, toParentVariation)),
								_p1._0.absolutelyPositioned),
							attrs: A2(
								_elm_lang$core$List$map,
								_user$project$ElementHelpers$mapVariation(toParentVariation),
								_p1._0.attrs)
						}));
			case 'Layout':
				return _mdgriffith$style_elements$Element_Internal_Model$Layout(
...
var _user$project$Reading$stylesheet = _mdgriffith$style_elements$Style$stylesheet(
	{ctor: '[]'});
var _user$project$Reading$Book = F4(
	function (a, b, c, d) {
		return {title: a, bookUrl: b, author: c, imageUrl: d};
	});
var _user$project$Reading$decodeBook = function (rawXml) {
	return function (xmlDoc) {
		return A5(
			_elm_lang$core$Result$map4,
			_user$project$Reading$Book,
			A3(_eeue56$elm_xml$Xml_Query$tag, 'title', _eeue56$elm_xml$Xml_Query$string, xmlDoc),
			A3(_eeue56$elm_xml$Xml_Query$tag, 'link', _eeue56$elm_xml$Xml_Query$string, xmlDoc),
			A3(
				_eeue56$elm_xml$Xml_Query$tag,
				'author',
				A2(_eeue56$elm_xml$Xml_Query$tag, 'name', _eeue56$elm_xml$Xml_Query$string),
				xmlDoc),
			A3(_eeue56$elm_xml$Xml_Query$tag, 'image_url', _eeue56$elm_xml$Xml_Query$string, xmlDoc));
	}(
		A2(
			_elm_lang$core$Result$withDefault,
			_eeue56$elm_xml$Xml_Encode$null,
			_eeue56$elm_xml$Xml_Decode$decode(rawXml)));
};
var _user$project$Reading$getCurrentlyReading = function (msg) {
	return A2(
		...
		function (bookResult) {
			return msg(
				A2(
					_elm_lang$core$Result$andThen,
					_user$project$Reading$decodeBook,
					A2(_elm_lang$core$Result$mapError, _elm_lang$core$Basics$toString, bookResult)));
		},
		_elm_lang$http$Http$getString('https://crossorigin.me/https://www.goodreads.com/review/list/?key=dwzdl5zmjovl9o41basow&v=2&shelf=currently-reading&id=32332180&page=1&per_page=1&sort=position&order=a'));
};
var _user$project$Reading$None = {ctor: 'None'};
var _user$project$Reading$element = function (book) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_user$project$Reading$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$row,
			_user$project$Reading$None,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					...
					book.bookUrl,
					_mdgriffith$style_elements$Element$text(book.title)),
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element$text(book.author),
					_1: {
						ctor: '::',
						_0: A4(
	...
	function (content, url) {
		return A2(
			...
			A3(
				...
				{ctor: '[]'},
				_mdgriffith$style_elements$Element$text(content)));
	});
var _user$project$Header$Header = {ctor: 'Header'};
var _user$project$Header$Top = {ctor: 'Top'};
var _user$project$Header$None = {ctor: 'None'};
var _user$project$Header$styles = {
	ctor: '::',
	_0: A2(
...
var _user$project$Header$spacer = A3(
	_mdgriffith$style_elements$Element$el,
	_user$project$Header$None,
	{
		ctor: '::',
		...
		A3(
			...
			{ctor: '[]'},
			{
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: _user$project$Header$name,
						_1: {
							ctor: '::',
							_0: A2(_user$project$Header$textLink, 'Projects', '#/projects'),
							_1: {
								ctor: '::',
...
var _user$project$Header$element = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$Header$None,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _user$project$Header$header,
		_1: {
			ctor: '::',
			_0: _user$project$Header$spacer,
			_1: {ctor: '[]'}
		}
	});

var _user$project$Page$getTitle = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'AboutPage':
			return 'About Ben';
		...
		case 'ProjectIndexPage':
			return 'Ben\'s Projects';
		default:
			return 'Ben\'s Prototypes';
	}
};
var _user$project$Page$PrototypesPage = {ctor: 'PrototypesPage'};
var _user$project$Page$ProjectIndexPage = {ctor: 'ProjectIndexPage'};
var _user$project$Page$ResumePage = {ctor: 'ResumePage'};
var _user$project$Page$AboutPage = {ctor: 'AboutPage'};

var _user$project$Msg$ResetCliplet = function (a) {
	return {ctor: 'ResetCliplet', _0: a};
};
var _user$project$Msg$BookReceived = function (a) {
	return {ctor: 'BookReceived', _0: a};
};
...
var _user$project$Project$Project = F6(
	function (a, b, c, d, e, f) {
		return {title: a, id: b, description: c, imageLocation: d, clipletLocation: e, url: f};
	});

var _user$project$Projects_Playbook$playbook = {title: 'Playbook', id: 'playbook', description: 'raising math from the dead', imageLocation: 'playbook.png', clipletLocation: 'playbook.webm', url: 'https://www.youtube.com/watch?v=ccBRIswpMzM'};

var _user$project$Projects_Prototypes$prototypes = {title: 'Prototypes', id: 'prototypes', description: 'games that were not to be', imageLocation: 'exquisine-icon.png', clipletLocation: 'exquisine-cliplet.webm', url: '#/prototypes'};

var _user$project$Projects_Quillbox$quillbox = {title: 'Quillbox', id: 'quillbox', description: 'type your latex quickly', imageLocation: 'quill.jpg', clipletLocation: '', url: 'quillbox'};

var _user$project$Projects_RainbowRacer$rainbowRacer = {title: 'Rainbow Racer', id: 'rainbow-racer', description: 'adrenalized arcade game', imageLocation: 'rainbowracer.png', clipletLocation: 'rainbowracer.webm', url: 'https://www.youtube.com/watch?v=2I4rqRBQX44'};

var _user$project$Projects_Spearmints$spearmints = {title: 'Spearmints', id: 'spearmints', description: 'room-scale VR escape game', imageLocation: 'spearmints-icon.png', clipletLocation: 'spearmints.webm', url: 'https://spearmints.itch.io/no-1'};

var _user$project$Projects_Symmetry$symmetry = {title: 'Symmetry', id: 'symmetry', description: 'explore the symmetries of tetrahedra', imageLocation: 'symmetry-icon.png', clipletLocation: 'symmetry-clip.webm', url: 'https://bengolds.github.io/Symmetry-Explorer/'};

var _user$project$Pages_ProjectIndex$categories = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: 'Software',
		_1: {
			ctor: '::',
			_0: _user$project$Projects_Playbook$playbook,
			_1: {
				ctor: '::',
				_0: _user$project$Projects_Symmetry$symmetry,
				_1: {ctor: '[]'}
			}
		}
	},
	_1: {
		...
		_0: {
			...
			_1: {
				ctor: '::',
				_0: _user$project$Projects_Spearmints$spearmints,
				_1: {
					ctor: '::',
					_0: _user$project$Projects_RainbowRacer$rainbowRacer,
					_1: {
						ctor: '::',
						_0: _user$project$Projects_Prototypes$prototypes,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Pages_ProjectIndex$CategoryName = {ctor: 'CategoryName'};
var _user$project$Pages_ProjectIndex$Category = {ctor: 'Category'};
var _user$project$Pages_ProjectIndex$Description = {ctor: 'Description'};
var _user$project$Pages_ProjectIndex$Title = {ctor: 'Title'};
var _user$project$Pages_ProjectIndex$Cliplet = {ctor: 'Cliplet'};
var _user$project$Pages_ProjectIndex$StaticImage = {ctor: 'StaticImage'};
var _user$project$Pages_ProjectIndex$ImageArea = {ctor: 'ImageArea'};
var _user$project$Pages_ProjectIndex$chipImage = function (project) {
	var videoId = A2(_elm_lang$core$Basics_ops['++'], project.id, '-cliplet');
	return A2(
		_mdgriffith$style_elements$Element$within,
		{
			ctor: '::',
			_0: A4(
				...
				_user$project$Pages_ProjectIndex$StaticImage,
				{
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$width(
						_mdgriffith$style_elements$Element_Attributes$percent(100)),
			...
			_1: {
				...
				_0: A4(
					...
					_user$project$Pages_ProjectIndex$Cliplet,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$width(
							_mdgriffith$style_elements$Element_Attributes$percent(100)),
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element_Attributes$id(videoId),
												_1: {ctor: '[]'}
											}
										}
									}
		...
		A3(
			_mdgriffith$style_elements$Element$el,
			_user$project$Pages_ProjectIndex$ImageArea,
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element_Attributes$height(
					_mdgriffith$style_elements$Element_Attributes$percent(100)),
				_1: {
					...
					_1: {
						...
						_0: _mdgriffith$style_elements$Element_Events$onMouseEnter(
							_user$project$Msg$ResetCliplet(videoId)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Pages_ProjectIndex$TextArea = {ctor: 'TextArea'};
var _user$project$Pages_ProjectIndex$Chip = {ctor: 'Chip'};
var _user$project$Pages_ProjectIndex$chip = function (project) {
	return A2(
		_mdgriffith$style_elements$Element$link,
		project.url,
		A3(
			_mdgriffith$style_elements$Element$row,
			_user$project$Pages_ProjectIndex$Chip,
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element_Attributes$width(
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$id(project.id),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			{
				ctor: '::',
				_0: _user$project$Pages_ProjectIndex$chipImage(project),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$column,
						_user$project$Pages_ProjectIndex$TextArea,
						{
							ctor: '::',
							_0: A2(
								_mdgriffith$style_elements$Element_Attributes$paddingXY,
						...
						},
						{
							...
							_0: A3(
								_mdgriffith$style_elements$Element$el,
								_user$project$Pages_ProjectIndex$Title,
								{ctor: '[]'},
								_mdgriffith$style_elements$Element$text(project.title)),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element$el,
									_user$project$Pages_ProjectIndex$Description,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text(project.description)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Pages_ProjectIndex$None = {ctor: 'None'};
var _user$project$Pages_ProjectIndex$styles = function () {
	var clipTransition = _mdgriffith$style_elements$Style_Transition$transitions(
		{
			ctor: '::',
			_0: {
				delay: 0,
	...
	return {
		...
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_user$project$Pages_ProjectIndex$None,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
					...
					_user$project$Pages_ProjectIndex$StaticImage,
					{
						...
						_1: {
							...
							_0: _mdgriffith$style_elements$Style$hover(
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style$opacity(0),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											_mdgriffith$style_elements$Style$style,
											_user$project$Pages_ProjectIndex$CategoryName,
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$black),
												_1: {
										...
										_1: {
											...
											_0: A2(
												_mdgriffith$style_elements$Style$style,
												_user$project$Pages_ProjectIndex$Category,
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Pages_ProjectIndex$category = function (_p0) {
	var _p1 = _p0;
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Pages_ProjectIndex$Category,
		...
		},
		{
			...
			_0: A3(
				...
				_user$project$Pages_ProjectIndex$CategoryName,
				{ctor: '[]'},
				_mdgriffith$style_elements$Element$text(_p1._0)),
			_1: {
				ctor: '::',
				_0: A3(
					...
					A2(_elm_lang$core$List$map, _user$project$Pages_ProjectIndex$chip, _p1._1)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Pages_ProjectIndex$element = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$Pages_ProjectIndex$None,
	{
		ctor: '::',
	...
	A2(_elm_lang$core$List$map, _user$project$Pages_ProjectIndex$category, _user$project$Pages_ProjectIndex$categories));
...
var _user$project$Stylesheet$Link = {ctor: 'Link'};
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Sheet$merge(
									A3(_mdgriffith$style_elements$Style_Sheet$map, _user$project$Stylesheet$ProjectIndexStyle, _elm_lang$core$Basics$identity, _user$project$Pages_ProjectIndex$styles)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Pages_About$element = function () {
		...
		A3(
			...
			},
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: paragraph('I like to make science and math come to life. I do this by transforming written words and equations into something you can poke and prod. Everyone transforms the systems they learn about into these interactive toys; they\'re just usually trapped inside of people\'s heads. I want to bring them out into the world so that we can all play with them together.'),
						_1: {
							ctor: '::',
							_0: paragraph('I started pursing these ideas when studying interactive graphics at Stanford. Since then, I\'ve worked at Pixar and Google. I left Google in 2016 to explore. Some of those explorations are captured on this website! Many others are secret explorations, tucked away in my heart.'),
							_1: {
								ctor: '::',
								_0: paragraph('When I\'m not in front of a screen, I\'m practicing aikido, going backpacking, or reading some Vonnegut. If you want to get a hold of me, I can be found at theotherben (at) gmail.com'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Pages_Prototypes$section = F3(
	function (title, imageSrc, contents) {
		return A3(
			_mdgriffith$style_elements$Element$textLayout,
			_user$project$Stylesheet$None,
			{
					...
					_0: A4(
						...
						_user$project$Stylesheet$None,
						{
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Attributes$width(
									_user$project$SharedStyles$pxUnits(32)),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Attributes$height(
										_user$project$SharedStyles$pxUnits(32)),
...
var _user$project$Pages_Prototypes$paragraph = function (string) {
	return A3(
		_mdgriffith$style_elements$Element$paragraph,
		_user$project$Stylesheet$BodyText,
		{ctor: '[]'},
...
var _user$project$Pages_Prototypes$link = F2(
	function (target, linkText) {
		return A2(
			_mdgriffith$style_elements$Element$link,
			target,
			A3(
				...
				_user$project$Stylesheet$Link,
				{ctor: '[]'},
				_mdgriffith$style_elements$Element$text(linkText)));
	});
var _user$project$Pages_Prototypes$element = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$Stylesheet$None,
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Element_Attributes$maxWidth(
			_user$project$SharedStyles$pxUnits(120)),
		_1: {
			ctor: '::',
			_0: _mdgriffith$style_elements$Element_Attributes$spacing(
				_user$project$SharedStyles$units(4)),
	...
	},
	{
		ctor: '::',
		_0: A3(
			_user$project$Pages_Prototypes$section,
			'Perspective Prototype',
			'perspective.png',
			{
				ctor: '::',
				_0: _user$project$Pages_Prototypes$paragraph('After playing The Witness, I was inspired to work on a puzzle game that explored perspective effects. Players solve the game\'s puzzles by switching between a 3D world and its 2D perspective projection. '),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$paragraph,
						...
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Element$text('It\'s all much easier to understand by watching '),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Pages_Prototypes$link, 'https://www.youtube.com/watch?v=fuOfg4JDFz8', 'a quick playthrough of the prototype.'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A3(
							...
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Element$text('This project was also a fun excuse to play with '),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Pages_Prototypes$link, '/assets/watercolor.png', 'watercolor'),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Element$text(' '),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Pages_Prototypes$link, '/assets/watercolor.mp4', 'shaders.'),
											_1: {ctor: '[]'}
										}
									}
								}
		...
		_1: {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _user$project$Pages_Prototypes$paragraph('You run an intergalactic restaurant with customers from all over the cosmos. Every key on your keyboard prepares a different dish. Make sure to prepare the right dish for each customer!'),
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$paragraph,
							...
							{
								ctor: '::',
								_0: A2(_user$project$Pages_Prototypes$link, '/assets/exquisine.mp4', 'This was a very silly game.'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Pages_Render$render = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'ProjectIndexPage':
			return A3(_user$project$ElementHelpers$styleMap, _user$project$Stylesheet$ProjectIndexStyle, _elm_lang$core$Basics$identity, _user$project$Pages_ProjectIndex$element);
		case 'AboutPage':
			return _user$project$Pages_About$element;
		case 'PrototypesPage':
			return _user$project$Pages_Prototypes$element;
		default:
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A3(
										...
										_user$project$Pages_Render$render(model.page)),
									_1: {ctor: '[]'}
								}
							}))),
				_1: {ctor: '[]'}
...
var _user$project$Main$pageParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Page$AboutPage, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Page$AboutPage,
				_evancz$url_parser$UrlParser$s('about')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Page$ResumePage,
					_evancz$url_parser$UrlParser$s('resume')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Page$ProjectIndexPage,
						_evancz$url_parser$UrlParser$s('projects')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Page$PrototypesPage,
							_evancz$url_parser$UrlParser$s('prototypes')),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$locationToPage = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Main$pageParser, location);
};
var _user$project$Main$locationToMsg = function (location) {
	var _p0 = _user$project$Main$locationToPage(location);
	if (_p0.ctor === 'Just') {
		return _user$project$Msg$UrlChange(_p0._0);
	} else {
		return _user$project$Msg$Noop;
	}
};
var _user$project$Main$outport = _elm_lang$core$Native_Platform.outgoingPort(
	'outport',
	function (v) {
		return {tag: v.tag, data: v.data};
	});
var _user$project$Main$sendInfoOut = function (info) {
	var _p1 = info;
	if (_p1.ctor === 'ResetClipletOut') {
		return _user$project$Main$outport(
			{
				tag: 'ResetCliplet',
				data: _elm_lang$core$Json_Encode$string(_p1._0)
			});
	} else {
		return _user$project$Main$outport(
			{
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {page: a, currentlyReading: b};
	});
var _user$project$Main$GenericOutsideData = F2(
	function (a, b) {
		return {tag: a, data: b};
	});
...
var _user$project$Main$init = function (location) {
	var currPage = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Page$AboutPage,
		_user$project$Main$locationToPage(location));
	return {
		ctor: '_Tuple2',
		_0: {
			page: currPage,
			currentlyReading: _elm_lang$core$Result$Err('no book')
		},
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$Reading$getCurrentlyReading(_user$project$Msg$BookReceived),
				_1: {
					ctor: '::',
					_0: _user$project$Main$sendInfoOut(
						_user$project$Main$SetTitle(
							_user$project$Page$getTitle(currPage))),
					_1: {ctor: '[]'}
				}
			})
	};
};
var _user$project$Main$ResetClipletOut = function (a) {
	return {ctor: 'ResetClipletOut', _0: a};
};
		...
		switch (_p2.ctor) {
			...
			case 'UrlChange':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{page: _p3}),
					_1: _user$project$Main$sendInfoOut(
						_user$project$Main$SetTitle(
							_user$project$Page$getTitle(_p3)))
				};
			case 'BookReceived':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					...
					_0: model,
					_1: _user$project$Main$sendInfoOut(
						_user$project$Main$ResetClipletOut(_p2._0))
				};
		}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Msg.Msg":{"args":[],"tags":{"ResetCliplet":["String"],"UrlChange":["Page.Page"],"Noop":[],"BookReceived":["Result.Result String Reading.Book"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.Page":{"args":[],"tags":{"AboutPage":[],"ResumePage":[],"ProjectIndexPage":[],"PrototypesPage":[]}}},"aliases":{"Reading.Book":{"args":[],"type":"{ title : String , bookUrl : String , author : String , imageUrl : String }"}},"message":"Msg.Msg"},"versions":{"elm":"0.18.0"}});
}
